...
The fourth folder is labelled 'sk' and contains all skeleton scripts organized into three folders that the buttons outlined in the launcher call and execute
The first is labelled 'SETUP' and it contains skeleton files corresponding to all the buttons in SCEXAO_SETUP.yml
The first is labelled 'INFRA_RED' and it contains skeleton files corresponding to all the buttons in SCEXAO_IR.yml
The first is labelled 'VISIBLE' and it contains skeleton files corresponding to all the buttons in SCEXAO_VIS.yml 
